...
public class Vision : MonoBehaviour
{
    ...
    [SerializeField] private LayerMask _occlusionMask; //blockvisibility, usually walls
    ...
    public bool TestVisibility(Vector3 point)
    {
        ...
        //occlusion
        //Linecast check collision between two points, 
    ...
    //draw visible gizmos in scene/game view, but only when GameObject is selected
